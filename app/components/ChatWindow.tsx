...
export default function ChatWindow({
    ...
    return (
        <div className="flex h-120 w-full flex-col">
            <div className="flex h-12 w-full items-center justify-start rounded-t-3xl bg-blue-400 pl-2">
                <button
                    type="button"
                    onClick={goBack}
            ...
            <div className="flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto p-4">
                ...
                {!loading &&
                    ...
                    messages.length === 0 && (
                        <p className="text-center text-sm text-stone-500">
                            Zatial tu nie su ziadne spravy.
                        </p>
                    )}
                ...
                {messages.map((item) => (
                    <div
                        key={item.id}
                        className={`flex max-w-3/4 items-end gap-2 ${item.sender === "me"
                    ...
                    >
                        ...
                        <span
                            className={`min-w-0 max-w-[25ch] break-words rounded-2xl px-3 py-2 ${item.sender === "me"
            ...
            <div
                ref={emojiPickerRef}
                className="relative mt-auto flex h-10 rounded-3xl border border-stone-400 text-stone-800"
            >
                <input
                    type="text"
